    ...
    <section id="about" className="py-20 px-6">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid md:grid-cols-2 gap-5 mb-12">
          {team.map((member, i) => (
            <motion.div
              ...
              className="p-7 rounded-3xl bg-card border border-border hover:border-primary/20 transition-all duration-300"
            >
        ...
        <motion.div
          ...
          className="p-7 rounded-3xl bg-primary/5 border border-primary/20 text-center"
        >
